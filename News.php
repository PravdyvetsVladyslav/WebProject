...
.date-filter:hover .dropdown-content {
    display: block;
}
  </style>
</head>
...
<div class="header">
    <div class="logo">
      <img src="photo/logo.png" alt="Just News Logo">
  ...
  <div class="container">
    ...
    <div class="date-filter">
        <button id="dateFilterButton">📆 Filter by date</button>
        <div id="dateFilterDropdown" class="dropdown-content">
            <input type="number" id="yearInput" placeholder="Year" min="2023" max="2024">
